            ...
            <div className="row">
                <div className="col-lg-12">
                    ...
                    <div className="form-group">.
                        <input type="text" className="form-control mt-2" placeholder="Họ tên" />
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        <input type="text" className="form-control mt-2" placeholder="Địa chỉ(ví dụ: 123 Nguyễn Trãi, Phường 1, Quận 1, Tp HCM)" />
                    </div>
                    <div className="form-group">
                       <textarea rows={3} className="form-control mt-2"  placeholder="Ghi chú thêm (Ví dụ: Giờ hành chính)" />
                    </div>
                            ...
                            <div className="payment-method_item">
                                <label className="radiobox">
                                    ...
                                    <span className="payment-method_icon">
                                        <img width="35" src="https://coolmate.cdn.vccloud.vn/images/momo-icon.png" />
                                    </span>
                                    <div>
                                        <h6>Ví dụ MOMO</h6>
                                    </div>
