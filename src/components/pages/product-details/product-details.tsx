        ...
        <div className="container1" style={{ marginTop: "10px" }}>
          ...
          <div className="chitiet">
            ...
            <div className="reviewsp">
              ...
              dệt nguyên khối vừa ôm dáng bàn chân vừa giữ được sự thoải mái tối
              ưu. Đế giày êm, nhẹ, độ đàn hồi cao. Giày thiết kế gọn nhẹ, thoải
              mái di chuyển, nhiều kiểu dáng màu sắc có thể lựa chọn.
            </div>
          </div>
        </div>
        <div className="container1" style={{ marginTop: "10px" }}>
